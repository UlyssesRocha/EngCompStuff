 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://inverter/", wsdlLocation = "http://localhost:9999/WS/HelloWorldWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://inverter/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/WS/HelloWorldWS?wsdl");
    ...
    public HelloWorldWS getHelloWorldImplPort() {
        return super.getPort(new QName("http://inverter/", "HelloWorldImplPort"), HelloWorldWS.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloWorldImplPort")
    public HelloWorldWS getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://inverter/", "HelloWorldImplPort"), HelloWorldWS.class, features);
    }
